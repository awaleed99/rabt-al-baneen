        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              كنيسة مارمرقس — أسرة الأبرار حضانة ({boys.length} ولد مقيد)
            </p>
          </div>
        </div>
            ...
            <tr>
              <td className="w-1/3 text-right align-top border-none p-0 bg-transparent">
                <h3 className="text-sm font-bold text-blue-900 mb-1">
                  كنيسة مارمرقس — أسرة الأبرار حضانة
                </h3>
                <p className="text-xs text-slate-600">
                  رابطة البنين — سجل المتابعة والرعاية
                </p>
              </td>
          ...
          <tbody>
            <tr>
              <td className="w-1/3 text-right border-none p-0 bg-transparent">
                منظومة رابطة البنين — سجل رسمي معتمد
              </td>
